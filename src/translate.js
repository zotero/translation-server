...
Zotero.Translate = {
	SandboxManager: require('./translate/sandboxManager'),
	ItemGetter: require('./translate/translate_item').ItemGetter,
	ItemSaver: require('./translate/translate_item').ItemSaver
}
